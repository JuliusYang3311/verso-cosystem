...
contextBridge.exposeInMainWorld('verso', {
  ...
  // Provider UI metadata (persisted outside verso.json to avoid gateway schema conflicts)
  loadProviderMeta: () => ipcRenderer.invoke('load-provider-meta'),
  saveProviderMeta: (meta) => ipcRenderer.invoke('save-provider-meta', meta),
