...
import { CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, OPENROUTER_DEFAULT_MODEL_REF, VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, XIAOMI_DEFAULT_MODEL_REF, ZAI_DEFAULT_MODEL_REF, XAI_DEFAULT_MODEL_REF, } from "./onboard-auth.credentials.js";
...
export function applyCloudflareAiGatewayProviderConfig(cfg, params) {
    ...
    const baseUrl = accountId && gatewayId ? resolveCloudflareAiGatewayBaseUrl({ accountId, gatewayId }) : "";
    if (baseUrl) {
...
export function applyKimiCodeProviderConfig(cfg) {
    ...
    models[KIMI_CODING_MODEL_REF] = {
        ...models[KIMI_CODING_MODEL_REF],
        alias: models[KIMI_CODING_MODEL_REF]?.alias ?? "Kimi Code",
    };
    models[KIMI_CODING_MODEL_REF] = {
        ...models[KIMI_CODING_MODEL_REF],
