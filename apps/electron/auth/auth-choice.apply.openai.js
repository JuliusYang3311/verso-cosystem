...
import { applyOpenAIConfig, applyOpenAIProviderConfig, OPENAI_DEFAULT_MODEL, } from "./openai-model-default.js";
export async function applyAuthChoiceOpenAI(params) {
    ...
    if (params.authChoice === "openai-codex") {
        ...
        try {
            ...
            await params.prompter.note("Trouble with OAuth? See https://docs.verso.ai/start/faq", "OAuth help");
        }
        return { config: nextConfig, agentModelOverride };
    }
    return null;
