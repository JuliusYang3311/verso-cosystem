...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = VersoLocationMode.off.rawValue
            ...
            Form {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Text("Keeps the screen awake while Verso is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
    ...
    private var locationMode: VersoLocationMode {
        VersoLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
