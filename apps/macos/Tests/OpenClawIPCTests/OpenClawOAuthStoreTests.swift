...
struct VersoOAuthStoreTests {
    ...
    func returnsMissingWhenFileAbsent() {
        ...
        #expect(VersoOAuthStore.anthropicOAuthStatus(at: url) == .missingFile)
    }

    @Test
    func usesEnvOverrideForVersoOAuthDir() throws {
        ...
        #expect(VersoOAuthStore.oauthDir().standardizedFileURL == dir.standardizedFileURL)
    }
    ...
    func acceptsPiFormatTokens() throws {
        ...
        #expect(VersoOAuthStore.anthropicOAuthStatus(at: url).isConnected)
    }
    ...
    func reportsMissingProviderEntry() throws {
        ...
        #expect(VersoOAuthStore.anthropicOAuthStatus(at: url) == .missingProviderEntry)
    }
    ...
    func reportsMissingTokens() throws {
        ...
        #expect(VersoOAuthStore.anthropicOAuthStatus(at: url) == .missingTokens)
    }
