...
enum UIStrings {
    static let welcomeTitle = "Welcome to Verso"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: VersoOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: VersoChatViewModel
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: VersoChatViewModel(
