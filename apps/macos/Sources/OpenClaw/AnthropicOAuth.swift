...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Verso token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: VersoOAuthStore.AnthropicOAuthStatus = VersoOAuthStore
...
enum VersoOAuthStore {
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Verso OAuth token file not found"
            case .unreadableFile: "Verso OAuth token file not readable"
            case .invalidJSON: "Verso OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Verso OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Verso OAuth credentials found"
            }
        }
    }
