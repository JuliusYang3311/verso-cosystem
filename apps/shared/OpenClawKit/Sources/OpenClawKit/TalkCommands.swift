...
public enum VersoTalkCommand: String, Codable, Sendable {
...
public struct VersoTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct VersoTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
