...
public typealias VersoPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias VersoPlatformImage = UIImage
#endif

public struct VersoChatUsageCost: Codable, Hashable, Sendable {
...
public struct VersoChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: VersoChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(VersoChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct VersoChatMessageContent: Codable, Hashable, Sendable {
...
public struct VersoChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [VersoChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: VersoChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [VersoChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: VersoChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(VersoChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([VersoChatMessageContent].self, forKey: .content) {
...
public struct VersoChatHistoryPayload: Codable, Sendable {
...
public struct VersoSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct VersoSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [VersoSessionPreviewItem]
}

public struct VersoSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [VersoSessionPreviewEntry]

    public init(ts: Int, previews: [VersoSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct VersoChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct VersoChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct VersoAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct VersoChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct VersoGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct VersoPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: VersoPlatformImage?
...
public struct VersoChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
