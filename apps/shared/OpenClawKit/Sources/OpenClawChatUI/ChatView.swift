...
@MainActor
public struct VersoChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: VersoChatViewModel
    ...
    private var visibleMessages: [VersoChatMessage] {
        let base: [VersoChatMessage]
    ...
    private func mergeToolResults(in messages: [VersoChatMessage]) -> [VersoChatMessage] {
    ...
    private func isToolResultMessage(_ message: VersoChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: VersoChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: VersoChatMessage) -> String {
