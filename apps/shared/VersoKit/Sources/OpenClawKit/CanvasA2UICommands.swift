...
public enum VersoCanvasA2UICommand: String, Codable, Sendable {
...
public struct VersoCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct VersoCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
