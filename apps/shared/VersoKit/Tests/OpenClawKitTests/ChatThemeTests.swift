...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = VersoChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = VersoChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
