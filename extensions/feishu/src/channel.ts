import type { ChannelMeta, ChannelPlugin, VersoConfig } from "verso/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "verso/plugin-sdk";
