...
export function listWhatsAppAuthDirs(cfg: VersoConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: VersoConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: VersoConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: VersoConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function resolveWhatsAppAccount(params: {
  ...
  return {
    ...
    messagePrefix: accountCfg?.messagePrefix ?? rootCfg?.messagePrefix,
    authDir,
...
export function listEnabledWhatsAppAccounts(cfg: VersoConfig): ResolvedWhatsAppAccount[] {
