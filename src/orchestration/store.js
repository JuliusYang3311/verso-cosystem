 ...
 */
export function resolveMissionWorkspace(sourceWorkspaceDir, orchId) {
 ...
 */
export function resolveSourceWorkspaceDir(missionWorkspaceDir) {
 ...
 */
export function createMissionWorkspace(sourceWorkspaceDir, orchId) {
 ...
 */
export async function initMissionWorkspace(sourceWorkspaceDir, orchId) {
  return createMissionWorkspace(sourceWorkspaceDir, orchId);
}
/**
 * Clean up a mission workspace by removing the directory.
 */
export async function cleanupMissionWorkspace(sourceWorkspaceDir, orchId) {
  const missionDir = resolveMissionWorkspace(sourceWorkspaceDir, orchId);
  if (!fs.existsSync(missionDir)) {
    return;
  }
 ...
 */
export async function copyMissionToOutput(sourceWorkspaceDir, orchId, outputDir) {
  const missionDir = resolveMissionWorkspace(sourceWorkspaceDir, orchId);
  if (!fs.existsSync(missionDir)) {
...
export async function saveOrchestration(orch) {
  ensureDir();
...
export async function loadOrchestration(id) {
...
export async function updateOrchestration(id, updater) {
...
// --- Helpers ---
export async function copyWorkspace(src, dest) {
