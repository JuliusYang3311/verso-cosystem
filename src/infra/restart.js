...
export function triggerVersoRestart() {
  ...
  if (process.platform !== "darwin") {
    if (process.platform === "linux") {
      const unit = normalizeSystemdUnit(process.env.VERSO_SYSTEMD_UNIT, process.env.VERSO_PROFILE);
  ...
  const label =
    process.env.VERSO_LAUNCHD_LABEL || resolveGatewayLaunchAgentLabel(process.env.VERSO_PROFILE);
