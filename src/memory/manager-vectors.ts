...
export async function loadVectorExtension(db: DatabaseSync, vector: VectorState): Promise<boolean> {
...
export function ensureVectorTable(db: DatabaseSync, vector: VectorState, dimensions: number): void {
