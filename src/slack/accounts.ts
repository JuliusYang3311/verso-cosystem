...
export function listSlackAccountIds(cfg: VersoConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: VersoConfig): string {
...
function resolveAccountConfig(cfg: VersoConfig, accountId: string): SlackAccountConfig | undefined {
  const accounts = cfg.channels?.slack?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSlackAccountConfig(cfg: VersoConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: VersoConfig): ResolvedSlackAccount[] {
