import type { VersoConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: VersoConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: VersoConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: VersoConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[verso]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: VersoConfig, channel: string): Record<string, unknown> | undefined {
