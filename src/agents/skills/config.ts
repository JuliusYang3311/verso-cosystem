...
import type { VersoConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: VersoConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: VersoConfig | undefined, pathStr: string): boolean {
...
export function resolveBundledAllowlist(config?: VersoConfig): string[] | undefined {
