...
export const DEFAULT_SANDBOX_IMAGE = "verso-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "verso-sbx-";
...
export const DEFAULT_TOOL_DENY = ["browser", "canvas", "nodes", "cron", "gateway", ...CHANNEL_IDS];
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "verso-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "verso-sandbox-common:bookworm-slim";
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "verso-sbx-browser-";
